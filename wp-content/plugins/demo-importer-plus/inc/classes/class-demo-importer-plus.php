...
if ( ! class_exists( 'Demo_Importer_Plus' ) ) {
	...
	class Demo_Importer_Plus {
		...
		public function admin_enqueue( $hook = '' ) {
			...
			$admin_app = include_once DEMO_IMPORTER_PLUS_DIR . 'dist/admin.bundle.asset.php';

			$asset_version = $admin_app[ 'version' ] ?? DEMO_IMPORTER_PLUS_VER;
			wp_register_script( 'demo-importer-plus-admin-app', DEMO_IMPORTER_PLUS_URI . 'dist/admin.bundle.js', $admin_app[ 'dependencies' ] ?? array(), $asset_version, true );
			wp_register_style( 'demo-importer-plus-admin-app', DEMO_IMPORTER_PLUS_URI . "dist/admin.bundle.css", array( 'wp-components' ), $asset_version );
			$current_screen = get_current_screen();
			if ( 'appearance_page_demo-importer-plus' === $current_screen->id ) {
				wp_enqueue_script( 'wp-api-request' );
				wp_enqueue_style( 'demo-importer-plus-admin-app' );
				wp_enqueue_script( 'demo-importer-plus-admin-app' );
			}
		}

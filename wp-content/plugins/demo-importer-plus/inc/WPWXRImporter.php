...
if ( class_exists( 'WP_Importer' ) ) :
	 ...
	 * WXR Importer
	 */
	class WPWXRImporter extends WP_Importer {
		/**
		...
		protected function process_post( $data, $meta, $comments, $terms ) {
			...
			if ( in_array( $data[ 'post_type' ], array( 'booking', 'customer', 'enquiry', 'wte-coupon' ) ) ) {
				return false;
			}
			/**
		 ...
		 */
		public function process_attachment( $post, $meta, $remote_url ) {
			...
			update_post_meta( $post_id, '_upload_meta', array(
				'upload'     => $upload,
		...
		protected function fetch_remote_file( $url, $post ) {
			...
			// Get a placeholder file in the upload dir with a unique, sanitized filename.

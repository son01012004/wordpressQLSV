...
const PopularPosts = ({ attributes }) => {
    ...
    return <BlockSection className="rishi_sidebar_widget_popular_post" titleSelector={popularTitleSelector} sectionLabel={popularPostLabel} layoutStyle={layoutStyle}>

			...
			<PanelRow>{__("Configure all the author details here:", "rishi-companion")}</PanelRow>
                <div className="rishi-blocks-option components-base-control">                
					...
					<div className="rishi-blocks-option">
						<SelectControl
							...
							onChange    ={(newType) =>
								setAttributes({ authorBioTitleSelector: newType })
							}
						/>
					</div>
					<TextControl
				...
				<div className="rishi-blocks-option components-base-control">
					<SelectControl
						...
						value	   = {authorBioType}
						options    =  {[
							{ value: "gravatar", label: __("Gravatar", "rishi-companion") },
							{ value: "authorbioimage", label: __("Upload Photo","rishi-companion") },
						]}
						onChange = { ( newType ) =>

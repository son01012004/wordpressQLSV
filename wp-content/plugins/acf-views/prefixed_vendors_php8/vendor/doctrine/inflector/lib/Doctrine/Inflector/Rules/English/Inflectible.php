...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('(s)tatuses$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2tatus'));
        (yield new Transformation(new Pattern('(s)tatus$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2tatus'));
        (yield new Transformation(new Pattern('(c)ampus$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2ampus'));
        (yield new Transformation(new Pattern('^(.*)(menu)s$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2'));
        ...
        (yield new Transformation(new Pattern('(m)ovies$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2ovie'));
        (yield new Transformation(new Pattern('(s)eries$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2eries'));
        ...
        (yield new Transformation(new Pattern('(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2sis'));
        ...
        (yield new Transformation(new Pattern('(p)eople$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2erson'));
        (yield new Transformation(new Pattern('(m)en$'), '\\1an'));
        (yield new Transformation(new Pattern('(c)hildren$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2hild'));
        (yield new Transformation(new Pattern('(f)eet$'), '\\1oot'));
        (yield new Transformation(new Pattern('(n)ews$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2ews'));
    ...
    {
        (yield new Transformation(new Pattern('(s)tatus$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2tatuses'));
        (yield new Transformation(new Pattern('(quiz)$'), '\\1zes'));
        (yield new Transformation(new Pattern('^(ox)$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2en'));
        ...
        (yield new Transformation(new Pattern('(?:([^f])fe|([lr])f)$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2ves'));
        ...
        (yield new Transformation(new Pattern('(buffal|her|potat|tomat|volcan)o$'), 'Org\\Wplake\\Advanced_Views\\Optional_Vendors\\1\\2oes'));

...
use Org\Wplake\Advanced_Views\Optional_Vendors\Random\Randomizer;
class Arr
{
    use Macroable;
    /**
    ...
    {
        if (\is_null($callback)) {
            return empty($array) ? \Org\Wplake\Advanced_Views\Optional_Vendors\value($default) : \end($array);
        }
    ...
    public static function get($array, $key, $default = null)
    {
        ...
        if (!\str_contains($key, '.')) {
            return $array[$key] ?? \Org\Wplake\Advanced_Views\Optional_Vendors\value($default);
        }
    ...
    public static function pluck($array, $value, $key = null)
    {
        ...
        foreach ($array as $item) {
            $itemValue = \Org\Wplake\Advanced_Views\Optional_Vendors\data_get($item, $value);
            ...
            if (\is_null($key)) {
                ...
                $itemKey = \Org\Wplake\Advanced_Views\Optional_Vendors\data_get($item, $key);

...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Support\Jsonable;
...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Support\Enumerable;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Support\HigherOrderCollectionProxy;
...
trait EnumeratesValues
{
     ...
     */
    protected static $proxies = ['average', 'avg', 'contains', 'doesntContain', 'each', 'every', 'filter', 'first', 'flatMap', 'groupBy', 'keyBy', 'map', 'max', 'min', 'partition', 'percentage', 'reject', 'skipUntil', 'skipWhile', 'some', 'sortBy', 'sortByDesc', 'sum', 'takeUntil', 'takeWhile', 'unique', 'unless', 'until', 'when'];
    /**

...
use Closure;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Bus\Events\BatchDispatched;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Container\Container;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Events\Dispatcher as EventDispatcher;
...
use Org\Wplake\Advanced_Views\Optional_Vendors\Laravel\SerializableClosure\SerializableClosure;
use Throwable;
class PendingBatch
{
    use Conditionable;
    ...
    protected function store($repository)
    {
        ...
        collect($this->beforeCallbacks())->each(function ($handler) use($batch) {
            try {
                ...
                if (\function_exists('Org\\Wplake\\Advanced_Views\\Optional_Vendors\\report')) {
                    report($e);
                }
            }
        });

...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Support\HtmlString;
...
class ComponentAttributeBag implements ArrayAccess, IteratorAggregate, JsonSerializable, Htmlable, Stringable
{
    ...
    {
        return $this->getIterator()->current() ?? \Org\Wplake\Advanced_Views\Optional_Vendors\value($default);
    }
    /**
    ...
    {
        return $this->attributes[$key] ?? \Org\Wplake\Advanced_Views\Optional_Vendors\value($default);
    }
    /**
    ...
    {
        return new static(\Org\Wplake\Advanced_Views\Optional_Vendors\collect($this->attributes)->filter($callback)->all());
    }
    /**
    ...
    public function merge(array $attributeDefaults = [], $escape = \true)
    {
        ...
        [$appendableAttributes, $nonAppendableAttributes] = \Org\Wplake\Advanced_Views\Optional_Vendors\collect($this->attributes)->partition(function ($value, $key) use($attributeDefaults) {

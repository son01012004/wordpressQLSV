...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\View\Factory as FactoryContract;
...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\View\Engines\EngineResolver;
...
class Factory implements FactoryContract
{
    ...
    public function file($path, $data = [], $mergeData = [])
    {
        ...
        return \Org\Wplake\Advanced_Views\Optional_Vendors\tap($this->viewInstance($path, $path, $data), function ($view) {
    ...
    public function make($view, $data = [], $mergeData = [])
    {
        ...
        $data = \array_merge($mergeData, $this->parseData($data));
        return \Org\Wplake\Advanced_Views\Optional_Vendors\tap($this->viewInstance($view, $path, $data), function ($view) {
            $this->callCreator($view);
        });
    }
    /**

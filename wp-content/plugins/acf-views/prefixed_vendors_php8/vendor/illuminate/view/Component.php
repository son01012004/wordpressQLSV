...
abstract class Component
{
    ...
    protected static function extractConstructorParameters()
    {
        if (!isset(static::$constructorParametersCache[static::class])) {
            ...
            static::$constructorParametersCache[static::class] = $constructor ? \Org\Wplake\Advanced_Views\Optional_Vendors\collect($constructor->getParameters())->map->getName()->all() : [];
        }
    ...
    protected function extractPublicProperties()
    {
        ...
        if (!isset(static::$propertyCache[$class])) {
            ...
            static::$propertyCache[$class] = \Org\Wplake\Advanced_Views\Optional_Vendors\collect($reflection->getProperties(ReflectionProperty::IS_PUBLIC))->reject(function (ReflectionProperty $property) {
    ...
    protected function extractPublicMethods()
    {
        ...
        if (!isset(static::$methodCache[$class])) {
            $reflection = new ReflectionClass($this);
            static::$methodCache[$class] = \Org\Wplake\Advanced_Views\Optional_Vendors\collect($reflection->getMethods(ReflectionMethod::IS_PUBLIC))->reject(function (ReflectionMethod $method) {
    ...
    public static function ignoredParameterNames()
    {
        if (!isset(static::$ignoredParameterNames[static::class])) {
            ...
            static::$ignoredParameterNames[static::class] = \Org\Wplake\Advanced_Views\Optional_Vendors\collect($constructor->getParameters())->map->getName()->all();
        }
        return static::$ignoredParameterNames[static::class];
    }
    /**

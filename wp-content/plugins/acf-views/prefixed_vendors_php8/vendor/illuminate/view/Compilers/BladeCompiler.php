...
namespace Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\View\Compilers;
...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\View\Factory as ViewFactory;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\View\View;
...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Support\Traits\ReflectsClosures;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\View\Component;
...
class BladeCompiler extends Compiler implements CompilerInterface
{
     ...
     * @var string
     */
    protected $echoFormat = '\Org\Wplake\Advanced_Views\Optional_Vendors\e(%s)';
    /**
    ...
    {
        return \Org\Wplake\Advanced_Views\Optional_Vendors\collect(\token_get_all($contents))->pluck(0)->filter(function ($token) {
    ...
    public static function render($string, $data = [], $deleteCachedView = \false)
    {
        ...
        return \Org\Wplake\Advanced_Views\Optional_Vendors\tap($view->render(), function () use($view, $deleteCachedView) {
            if ($deleteCachedView) {
                @\unlink($view->getPath());
            }
        });
    ...
    {
        $data = $component->data();
        $view = \Org\Wplake\Advanced_Views\Optional_Vendors\value($component->resolveView(), $data);
    ...
    public function component($class, $alias = null, $prefix = '')
    {
        ...
        if (\is_null($alias)) {
            $alias = \str_contains($class, '\\View\\Components\\') ? \Org\Wplake\Advanced_Views\Optional_Vendors\collect(\explode('\\', Str::after($class, '\\View\\Components\\')))->map(function ($segment) {
    ...
    {
        $this->setEchoFormat('\Org\Wplake\Advanced_Views\Optional_Vendors\e(%s, true)');
    }
    /**
    ...
    {
        $this->setEchoFormat('\Org\Wplake\Advanced_Views\Optional_Vendors\e(%s, false)');
    }
    /**

...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Support\Arrayable;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Support\Htmlable;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Support\MessageProvider;
...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\View\View as ViewContract;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Support\MessageBag;
...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Support\ViewErrorBag;
use Stringable;
use Throwable;
class View implements ArrayAccess, Htmlable, Stringable, ViewContract
{
    ...
    {
        return \is_null($fragments) ? $this->allFragments() : \Org\Wplake\Advanced_Views\Optional_Vendors\collect($fragments)->map(fn($f) => $this->fragment($f))->implode('');
    }
    /**
    ...
    {
        if (\Org\Wplake\Advanced_Views\Optional_Vendors\value($boolean)) {
    ...
    {
        return \Org\Wplake\Advanced_Views\Optional_Vendors\collect($this->render(fn() => $this->factory->getFragments()))->implode('');
    }
    /**

...
namespace Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\View\Concerns;
...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\View\ComponentSlot;
trait ManagesComponents
{
    ...
    public function renderComponent()
    {
        ...
        try {
            $view = \Org\Wplake\Advanced_Views\Optional_Vendors\value($view, $data);
    ...
    public function getConsumableComponentData($key, $default = null)
    {
        ...
        if ($currentComponent === 0) {
            return \Org\Wplake\Advanced_Views\Optional_Vendors\value($default);
        }

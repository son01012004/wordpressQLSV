...
use Closure;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Mail\Factory;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Mail\Mailable;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Mail\Mailer;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Mail\MailQueue;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Queue\ShouldQueue;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Mail\MailManager;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Support\Traits\ForwardsCalls;
...
class MailFake implements Factory, Fake, Mailer, MailQueue
{
    ...
    {
        $mailableNames = collect($this->mailables)->map(fn($mailable) => \get_class($mailable))->join("\n- ");
    ...
    {
        $mailableNames = collect($this->queuedMailables)->map(fn($mailable) => \get_class($mailable))->join("\n- ");
    ...
    {
        $total = collect($this->mailables)->concat($this->queuedMailables)->count();

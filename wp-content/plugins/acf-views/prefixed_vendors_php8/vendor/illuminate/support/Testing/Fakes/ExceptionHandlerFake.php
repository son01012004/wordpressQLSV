...
use Closure;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Contracts\Debug\ExceptionHandler;
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Foundation\Testing\Concerns\WithoutExceptionHandlingHandler;
...
use Org\Wplake\Advanced_Views\Optional_Vendors\Illuminate\Testing\Assert;
use Org\Wplake\Advanced_Views\Optional_Vendors\PHPUnit\Framework\Assert as PHPUnit;
use Org\Wplake\Advanced_Views\Optional_Vendors\PHPUnit\Framework\ExpectationFailedException;
use Throwable;
/**
...
class ExceptionHandlerFake implements ExceptionHandler, Fake
{
    ...
    public function assertReported(Closure|string $exception)
    {
        ...
        Assert::assertTrue(collect($this->reported)->contains(fn(Throwable $e) => $this->firstClosureParameterType($exception) === \get_class($e) && $exception($e) === \true), $message);
    }
    /**

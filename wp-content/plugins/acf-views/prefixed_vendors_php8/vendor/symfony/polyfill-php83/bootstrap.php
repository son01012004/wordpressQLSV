 ...
 */
use Org\Wplake\Advanced_Views\Optional_Vendors\Symfony\Polyfill\Php83 as p;
if (\PHP_VERSION_ID >= 80300) {
    return;
}
if (!\function_exists('Org\\Wplake\\Advanced_Views\\Optional_Vendors\\json_validate')) {
    function json_validate(string $json, int $depth = 512, int $flags = 0) : bool
    {
        return p\Php83::json_validate($json, $depth, $flags);
    }
}
if (!\function_exists('Org\\Wplake\\Advanced_Views\\Optional_Vendors\\mb_str_pad') && \function_exists('mb_substr')) {
    function mb_str_pad(string $string, int $length, string $pad_string = ' ', int $pad_type = \STR_PAD_RIGHT, ?string $encoding = null) : string
    {
        return p\Php83::mb_str_pad($string, $length, $pad_string, $pad_type, $encoding);
    }
}
if (!\function_exists('Org\\Wplake\\Advanced_Views\\Optional_Vendors\\stream_context_set_options')) {
    function stream_context_set_options($context, array $options) : bool
    {
        return \stream_context_set_option($context, $options);
    }
}
if (!\function_exists('Org\\Wplake\\Advanced_Views\\Optional_Vendors\\str_increment')) {
    function str_increment(string $string) : string
    {
        return p\Php83::str_increment($string);
    }
}
if (!\function_exists('Org\\Wplake\\Advanced_Views\\Optional_Vendors\\str_decrement')) {
...
if (!\function_exists('Org\\Wplake\\Advanced_Views\\Optional_Vendors\\ldap_connect_wallet') && \function_exists('ldap_connect')) {
    function ldap_connect_wallet(?string $uri, string $wallet, string $password, int $auth_mode = \Org\Wplake\Advanced_Views\Optional_Vendors\GSLC_SSL_NO_AUTH)
    {

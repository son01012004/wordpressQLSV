...
use Org\Wplake\Advanced_Views\Optional_Vendors\Carbon\Exceptions\InvalidDateException;
use Org\Wplake\Advanced_Views\Optional_Vendors\Carbon\Exceptions\InvalidFormatException;
use Org\Wplake\Advanced_Views\Optional_Vendors\Carbon\Exceptions\InvalidTimeZoneException;
use Org\Wplake\Advanced_Views\Optional_Vendors\Carbon\Exceptions\OutOfRangeException;
use Org\Wplake\Advanced_Views\Optional_Vendors\Carbon\Exceptions\UnitException;
use Org\Wplake\Advanced_Views\Optional_Vendors\Carbon\Month;
use Org\Wplake\Advanced_Views\Optional_Vendors\Carbon\Translator;
use Org\Wplake\Advanced_Views\Optional_Vendors\Carbon\WeekDay;
use Closure;
use Org\Wplake\Advanced_Views\Optional_Vendors\DateMalformedStringException;
...
trait Creator
{
    ...
    public static function createFromFormat($format, $time, $timezone = null) : ?self
    {
        ...
        if (!\is_string($time)) {
            @\trigger_error('createFromFormat() will only accept string or integer for 1-letter format representing a numeric unit int next version', \E_USER_DEPRECATED);
            $time = (string) $time;
        }
        if (!$function) {

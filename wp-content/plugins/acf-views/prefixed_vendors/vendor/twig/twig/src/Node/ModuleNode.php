 ...
 */
namespace Org\Wplake\Advanced_Views\Vendors\Twig\Node;
...
final class ModuleNode extends Node
{
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler->write("use \\Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Environment;\n")->write("use \\Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Error\\LoaderError;\n")->write("use \\Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Error\\RuntimeError;\n")->write("use \\Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Extension\\SandboxExtension;\n")->write("use \\Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Markup;\n")->write("use \\Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Sandbox\\SecurityError;\n")->write("use \\Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Sandbox\\SecurityNotAllowedTagError;\n")->write("use \\Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Sandbox\\SecurityNotAllowedFilterError;\n")->write("use \\Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Sandbox\\SecurityNotAllowedFunctionError;\n")->write("use \\Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Source;\n")->write("use \\Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Template;\n\n");
        }
        $compiler->write('/* ' . \str_replace('*/', '* /', $this->getSourceContext()->getName()) . " */\n")->write('class ' .  \substr( $compiler->getEnvironment()->getTemplateClass($this->getSourceContext()->getName(), $this->getAttribute('index')), 35 ) )->raw(" extends Template\n")->write("{\n")->indent()->write("private \$source;\n")->write("private \$macros = [];\n\n");
    }

...
abstract class IntegrationTestCase extends TestCase
{
    ...
    protected function doIntegrationTest($file, $message, $condition, $templates, $exception, $outputs, $deprecation = '')
    {
        ...
        foreach ($outputs as $i => $match) {
            ...
            $p->setAccessible(\true);
            $p->setValue($twig, '\\Org\\Wplake\\Advanced_Views\\Vendors\\__TwigTemplate_' . \hash(\PHP_VERSION_ID < 80100 ? 'sha256' : 'xxh128', \uniqid(\mt_rand(), \true), \false) . '_');
            $deprecations = [];
            try {
            ...
            if (\false !== $exception) {
                ...
                $constraintClass = \class_exists('Org\\Wplake\\Advanced_Views\\Vendors\\PHPUnit\\Framework\\Constraint\\Exception') ? 'PHPUnit\\Framework\\Constraint\\Exception' : 'PHPUnit_Framework_Constraint_Exception';

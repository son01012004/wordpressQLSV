...
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\AddBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\AndBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\BitwiseAndBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\BitwiseOrBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\BitwiseXorBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\ConcatBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\DivBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\EndsWithBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\EqualBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\FloorDivBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\GreaterBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\GreaterEqualBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\HasEveryBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\HasSomeBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\InBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\LessBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\LessEqualBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\MatchesBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\ModBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\MulBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\NotEqualBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\NotInBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\OrBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\PowerBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\RangeBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\SpaceshipBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\StartsWithBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Binary\SubBinary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Filter\DefaultFilter;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\NullCoalesceExpression;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Test\ConstantTest;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Test\DefinedTest;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Test\DivisiblebyTest;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Test\EvenTest;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Test\NullTest;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Test\OddTest;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Test\SameasTest;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Unary\NegUnary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Unary\NotUnary;
use Org\Wplake\Advanced_Views\Vendors\Twig\Node\Expression\Unary\PosUnary;
use Org\Wplake\Advanced_Views\Vendors\Twig\NodeVisitor\MacroAutoImportNodeVisitor;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\ApplyTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\BlockTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\DeprecatedTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\DoTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\EmbedTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\ExtendsTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\FlushTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\ForTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\FromTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\IfTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\ImportTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\IncludeTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\MacroTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\SetTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\UseTokenParser;
use Org\Wplake\Advanced_Views\Vendors\Twig\TokenParser\WithTokenParser;
...
final class CoreExtension extends AbstractExtension
{
    ...
    public function getFilters() : array
    {
        return [
            // formatting filters
            new TwigFilter('date', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_date_format_filter', ['needs_environment' => \true]),
            new TwigFilter('date_modify', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_date_modify_filter', ['needs_environment' => \true]),
            new TwigFilter('format', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_sprintf'),
            new TwigFilter('replace', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_replace_filter'),
            new TwigFilter('number_format', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_number_format_filter', ['needs_environment' => \true]),
            new TwigFilter('abs', 'abs'),
            new TwigFilter('round', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_round'),
            // encoding
            new TwigFilter('url_encode', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_urlencode_filter'),
            new TwigFilter('json_encode', 'json_encode'),
            new TwigFilter('convert_encoding', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_convert_encoding'),
            // string filters
            new TwigFilter('title', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_title_string_filter', ['needs_environment' => \true]),
            new TwigFilter('capitalize', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_capitalize_string_filter', ['needs_environment' => \true]),
            new TwigFilter('upper', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_upper_filter', ['needs_environment' => \true]),
            new TwigFilter('lower', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_lower_filter', ['needs_environment' => \true]),
            new TwigFilter('striptags', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_striptags'),
            new TwigFilter('trim', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_trim_filter'),
            new TwigFilter('nl2br', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_nl2br', ['pre_escape' => 'html', 'is_safe' => ['html']]),
            new TwigFilter('spaceless', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_spaceless', ['is_safe' => ['html']]),
            // array helpers
            new TwigFilter('join', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_join_filter'),
            new TwigFilter('split', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_split_filter', ['needs_environment' => \true]),
            new TwigFilter('sort', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_sort_filter', ['needs_environment' => \true]),
            new TwigFilter('merge', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_array_merge'),
            new TwigFilter('batch', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_array_batch'),
            new TwigFilter('column', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_array_column'),
            new TwigFilter('filter', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_array_filter', ['needs_environment' => \true]),
            new TwigFilter('map', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_array_map', ['needs_environment' => \true]),
            new TwigFilter('reduce', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_array_reduce', ['needs_environment' => \true]),
            // string/array filters
            new TwigFilter('reverse', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_reverse_filter', ['needs_environment' => \true]),
            new TwigFilter('length', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_length_filter', ['needs_environment' => \true]),
            new TwigFilter('slice', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_slice', ['needs_environment' => \true]),
            new TwigFilter('first', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_first', ['needs_environment' => \true]),
            new TwigFilter('last', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_last', ['needs_environment' => \true]),
            // iteration and runtime
            new TwigFilter('default', '\\Org\\Wplake\\Advanced_Views\\Vendors\\_twig_default_filter', ['node_class' => DefaultFilter::class]),
            new TwigFilter('keys', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_get_array_keys_filter'),
        ];
    }
    public function getFunctions() : array
    {
        return [new TwigFunction('max', 'max'), new TwigFunction('min', 'min'), new TwigFunction('range', 'range'), new TwigFunction('constant', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_constant'), new TwigFunction('cycle', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_cycle'), new TwigFunction('random', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_random', ['needs_environment' => \true]), new TwigFunction('date', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_date_converter', ['needs_environment' => \true]), new TwigFunction('include', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_include', ['needs_environment' => \true, 'needs_context' => \true, 'is_safe' => ['all']]), new TwigFunction('source', '\\Org\\Wplake\\Advanced_Views\\Vendors\\twig_source', ['needs_environment' => \true, 'is_safe' => ['all']])];
    }
...
namespace Org\Wplake\Advanced_Views\Vendors;

use Org\Wplake\Advanced_Views\Vendors\Twig\Environment;
use Org\Wplake\Advanced_Views\Vendors\Twig\Error\LoaderError;
use Org\Wplake\Advanced_Views\Vendors\Twig\Error\RuntimeError;
use Org\Wplake\Advanced_Views\Vendors\Twig\Extension\CoreExtension;
use Org\Wplake\Advanced_Views\Vendors\Twig\Extension\SandboxExtension;
use Org\Wplake\Advanced_Views\Vendors\Twig\Markup;
use Org\Wplake\Advanced_Views\Vendors\Twig\Source;
use Org\Wplake\Advanced_Views\Vendors\Twig\Template;
use Org\Wplake\Advanced_Views\Vendors\Twig\TemplateWrapper;
/**
 * Cycles over a value.
 *
...
{
    if (!$arrow instanceof \Closure && $env->hasExtension('Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Extension\\SandboxExtension') && $env->getExtension('Org\\Wplake\\Advanced_Views\\Vendors\\Twig\\Extension\\SandboxExtension')->isSandboxed()) {

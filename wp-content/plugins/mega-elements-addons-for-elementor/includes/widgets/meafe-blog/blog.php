...
class MEAFE_Blog extends Widget_Base
{
    ...
    */
    ...
    protected function render()
    {
        ...
        $settings_arry = [
            'bbcls_blog_show_image'                  => isset($settings['bbcls_blog_show_image']) ? $settings['bbcls_blog_show_image'] : 'yes',
            'bbcls_blog_show_title'                  => isset($settings['bbcls_blog_show_title']) ? $settings['bbcls_blog_show_title'] : 'yes',
            'bbcls_blog_show_excerpt'                => isset($settings['bbcls_blog_show_excerpt']) ? $settings['bbcls_blog_show_excerpt'] : 'yes',
            'bbcls_blog_show_author'                 => isset($settings['bbcls_blog_show_author']) ? $settings['bbcls_blog_show_author'] : 'yes',
            'bbcls_blog_show_author_avatar'          => isset($settings['bbcls_blog_show_author_avatar']) ? $settings['bbcls_blog_show_author_avatar'] : '',
            'bbcls_blog_show_date'                   => isset($settings['bbcls_blog_show_date']) ? $settings['bbcls_blog_show_date'] : 'yes',
            'bbcls_blog_show_category'               => isset($settings['bbcls_blog_show_category']) ? $settings['bbcls_blog_show_category'] : 'yes',
            'bbcls_blog_excerpt_length'              => isset($settings['bbcls_blog_excerpt_length']) ? intval( $settings['bbcls_blog_excerpt_length'], 10 ) : 10,
            'bbcls_blog_show_read_more_button'       => isset($settings['bbcls_blog_show_read_more_button']) ? $settings['bbcls_blog_show_read_more_button'] : 'yes',
            'bbcls_blog_read_more_button_text'       => isset($settings['bbcls_blog_read_more_button_text']) ? $settings['bbcls_blog_read_more_button_text'] : esc_html__( 'Read More', 'mega-elements-addons-for-elementor' ),
            'bbcls_blog_show_load_more'              => isset($settings['bbcls_blog_show_load_more']) ? $settings['bbcls_blog_show_load_more'] : '',
            'bbcls_blog_show_load_more_text'         => isset($settings['bbcls_blog_show_load_more_text']) ? $settings['bbcls_blog_show_load_more_text'] : esc_html__( 'Load More', 'mega-elements-addons-for-elementor' ),
            'bbcls_blog_show_load_more_url'          => isset($settings['bbcls_blog_show_load_more_url']) ? $settings['bbcls_blog_show_load_more_url'] : '#',
            'bbcls_blog_excerpt_expanison_indicator' => isset($settings['bbcls_blog_excerpt_expanison_indicator']) ? $settings['bbcls_blog_excerpt_expanison_indicator'] : esc_html__( '...', 'mega-elements-addons-for-elementor' ),
            'bbcls_blog_layout_mode'                 => isset($settings['bbcls_blog_layout_mode']) ? $settings['bbcls_blog_layout_mode'] : '1',
            'bbcqs_blog_orderby'                     => isset($settings['bbcqs_blog_orderby']) ? $settings['bbcqs_blog_orderby'] : 'date',
        ];

<?php
/**
 * Archive Customizer Setting
 */
namespace Rishi\Customizer\Settings;
use Rishi\Customizer\Abstracts\Customize_Settings;
use \Rishi\Customizer\ControlTypes;
class Archive_Setting extends Customize_Settings {

	protected function add_settings() {

		$archive_defaults = self::get_archive_default_value();

		$this->add_setting( 'archive_title_panel', array(
			...
			'innerControls' => array(
				\Rishi\Customizer\Helpers\Basic::uniqid() => array(
					...
					'options' => array(
						'ed_archive_header'       => array(
							'label'   => __( 'Enable Page Header', 'rishi' ),
							'control' => ControlTypes::INPUT_SWITCH,
							'value'   => 'yes',
						),
						'archive_page_prefix_ed'                  => array(
							'label'   => __( 'Prefix', 'rishi' ),
							'control' => ControlTypes::INPUT_SWITCH,
							'value'   => 'no',
							'divider' => 'top',
							'conditions' => [
								'ed_archive_header' => 'yes'
							]
						),
						'breadcrumbs_ed_archive'                  => array(
							'label'   => __( 'Breadcrumb', 'rishi' ),
							'control' => ControlTypes::INPUT_SWITCH,
							'value'   => $archive_defaults['breadcrumbs_ed_archive'],
							'divider' => 'top',
							'conditions' => [
								'ed_archive_header' => 'yes'
							]
						),
						'archive_page_title_ed'                   => array(
						...
						'archive_page_desc_ed'                    => array(
							'label'   => __( 'Archive Description', 'rishi' ),
							'help'    => __( 'You have to add Archive Description. It works for Tags and Categories of the Post.', 'rishi' ),
							'control' => ControlTypes::INPUT_SWITCH,
							'value'   => 'no',
							'divider' => 'top',
							'conditions' => [
						...
						'archive_page_archive_margin' => array(
							...
							'conditions' => [
								'ed_archive_header' => 'yes',
								'archive_page_search_ed' => 'yes'
							]
						),

						'archive_page_alignment'   => array(
				...
				\Rishi\Customizer\Helpers\Basic::uniqid() => array(
					...
					'control'    => ControlTypes::TAB,
					'options' => array(
						'archive_page_header_content_background' => array(
		...
		$this->add_setting('archive_page_layout', array(
			'label'   => __( 'Archive Page Layout', 'rishi' ),
			'help'    => __( 'Choose the Archive page layout for your site.', 'rishi' ),
			'control' => ControlTypes::IMAGE_PICKER,
			'value'   => $archive_defaults['archive_page_layout'],
			'attr'    => array(
		...
		$this->add_setting('archive_post_meta', array(
			'label'    => false,
		...
		$this->add_setting('archive_post_navigation', array(
			'label'   => __( 'Posts Navigation', 'rishi' ),
			'control' => ControlTypes::INPUT_SELECT,
			'value'   => $archive_defaults['archive_post_navigation'],
			'view'    => 'text',
			'design'  => 'block',
			'divider' => 'top',
			'choices' => \Rishi\Customizer\Helpers\Basic::ordered_keys(
		...
		$this->add_setting('archive_sidebar_layout', array(
			'label'   => __( 'Sidebar Layout', 'rishi' ),
			'control'    => ControlTypes::IMAGE_PICKER,
			'value'   => $archive_defaults['archive_sidebar_layout'],
			'attr'    => array(
				'data-columns' => '2',
			),
			'help'    => __( 'Choose sidebar layout for Archive page.', 'rishi' ),
			'divider' => 'top',
			'choices' => array(
		...
		$this->add_setting('archive_layout', array(
			'label'   => __( 'Archive Container', 'rishi' ),
			'control'    => ControlTypes::INPUT_SELECT,
			'value'   => $archive_defaults['archive_layout'],
			'view'    => 'text',
			'design'  => 'block',
			'divider' => 'top',
			'choices' => \Rishi\Customizer\Helpers\Basic::ordered_keys(
			...
			'help'    => __( 'Choose Archive page container layout.', 'rishi' ),
		));

		$this->add_setting('archive_layout_streched_ed', array(
			'label' => __( 'Stretch Layout', 'rishi' ),
			'help'  => __( 'This setting stretches the container width.', 'rishi' ),
			'control'  => ControlTypes::INPUT_SWITCH,
			'value' => $archive_defaults['archive_layout_streched_ed'],
			'divider'  => 'top',
		));
	}

	/**
	 * Set default value for archive page.
	 */
	protected static function get_archive_default_value() {
	...
	/**
	 * Layout choices for the archive page
	 *

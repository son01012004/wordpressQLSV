 ...
 * Class Menu
 */
class Menu_Secondary extends Abstracts\Builder_Element {
	public function get_id() {
		return 'menu-secondary';
	}

	public function get_label() {
		return __( 'Menu 2', 'rishi' );
	}
			...
			\Rishi\Customizer\Helpers\Basic::uniqid() => [
				...
				'options' => [
					...
					'menu'                                    => [
						...
						'help'		 => __( 'Select the menu that you prefer to display.', 'rishi' ),
	...
	public function dynamic_styles() {
		...
		$options = array(
			'headerMenuItemsSpacing' => array(
				'selector'     => '.site-header .site-navigation-2',
			...
			'headerMenuColor'      => array(
				...
				'type'      => 'color',
				'default'   => $header_default['menuFontColor'],
				'variables' => array(
					'default' => array(
						'variable' => 'linkInitialColor',
						'selector' => '.site-header .site-navigation-2 > ul > li > a',
					),
					'hover'   => array(
			...
			'headerDropdownFont' => array(
				...
				'selector'   => '.site-header .site-navigation-2 .sub-menu',
				'type'       => 'typography'
			),
			'headerDropdownBackground' => array(
	...
	public function render( $device = 'desktop') {
		...
		?>
		<nav id="site-navigation-2" class="<?php echo esc_attr( $class ); ?>">

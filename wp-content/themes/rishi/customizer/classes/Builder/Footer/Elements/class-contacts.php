...
class Contacts extends Abstracts\Builder_Element {
		...
		$options = [
			\Rishi\Customizer\Helpers\Basic::uniqid() => [
				...
				'options' => [
					...
					'contact_items' => [
						...
						'help' => __('Display your Social Icons', 'rishi'),
			...
			\Rishi\Customizer\Helpers\Basic::uniqid() => [
				...
				'options' => [
					...
					'footer_contacts_font' => rishi_typography_control_option([
	...
	public function dynamic_styles() {
		$contact_default = \Rishi\Customizer\Helpers\Defaults::get_footer_defaults();
		$contacts_margin = $this->get_mod_value('contacts_margin', $contact_default['contacts_margin']);
		$icon_size = $this->get_mod_value('contacts_icon_size', $contact_default['contacts_icon_size']);
		$item_space = $this->get_mod_value('contacts_spacing', $contact_default['contacts_spacing']);
		$footer_contacts_font = $this->get_mod_value('footer_contacts_font', $contact_default['footer_contacts_font']);
		$contacts_font_color = $this->get_mod_value('contacts_font_color', $contact_default['contacts_font_color']);
		$contacts_icon_color = $this->get_mod_value('contacts_icon_color', $contact_default['contacts_icon_color']);
		$contacts_icon_bg = $this->get_mod_value('contacts_icon_background', $contact_default['contacts_icon_background']);

		return array(
			'footer_contacts_font' => array(
				'value' => $footer_contacts_font,
				'selector' => '#rishi-footer-contacts',
				'type' => 'typography'
			),
			'footer_contacts_margin' => [
				'selector' => '#rishi-footer-contacts',
				'variableName' => 'margin',

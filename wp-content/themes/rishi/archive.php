...
if( is_author() ) $archive_page_layout = get_theme_mod( 'author_page_layout', $defaults['author_page_layout'] );
...
get_header();
	...
	*/
	...
	<main id="primary" class="site-main">
		...
		<div class="rishi-container-wrap <?php echo ( $archive_page_layout == 'masonry_grid' ) ? esc_attr( $archive_page_layout ) : ''; ?>">
			<?php
				/**

...
$archive_structure   = get_theme_mod( 'archive_post_meta', Defaults::blogpost_structure_defaults() );
$archive_page_layout = get_theme_mod( 'archive_page_layout', $defaults['archive_page_layout'] );

if( is_author() ){
	$archive_structure   = get_theme_mod( 'author_post_structure', Defaults::blogpost_structure_defaults() );
